          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            {socials.map((social, index) => (
              <motion.a
                ...
                className="bg-[#141414] border border-[#262626] rounded-xl p-6 card-hover group"
              >
                <social.icon className="w-8 h-8 mx-auto mb-3 text-[#a1a1aa] group-hover:text-[#3b82f6] transition-colors" />
                <p className="font-medium group-hover:text-[#3b82f6] transition-colors">{social.name}</p>
              </motion.a>
            ))}
          </div>
